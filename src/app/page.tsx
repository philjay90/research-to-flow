    ...
    <>
      ...
      <main className="mx-auto max-w-3xl px-8 py-16">
        <div className="mb-10 flex items-end justify-between">
          <div>
            <p className="mb-1 text-sm font-medium text-[#86868B]">Your workspaces</p>
        ...
        {!projects || projects.length === 0 ? (
          <div className="flex flex-col items-center justify-center rounded-2xl bg-white py-20 text-center shadow-sm">
            ...
            <p className="mt-2 text-sm text-[#86868B]">Create your first project to get started.</p>
                ...
                <div className="group rounded-2xl bg-white shadow-sm transition-shadow hover:shadow-md">
                  <div className="flex items-center gap-4 p-6">
                    <Link href={`/projects/${project.id}`} className="min-w-0 flex-1">
                      ...
                      {project.description && (
                        <p className="mt-1 text-sm text-[#86868B] leading-relaxed">{project.description}</p>
                      )}
                      <p className="mt-2 text-xs text-[#86868B]/60">
